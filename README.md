...
You can now find the theme under Settings --> Appearance ---> Icons & Tollkit theming. There's a known bug that the icons doesn't shift to a newly installed icon theme. You have to logout and login before the change appears.
